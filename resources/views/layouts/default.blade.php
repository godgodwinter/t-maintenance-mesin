      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user text-monza">
            ...
            <div class="d-sm-none d-lg-inline-block">{{ Auth::user()->name }} ( {{ ucfirst(Auth::user()->tipeuser) }} )</div></a>
    ...
    @include('includes.sidebar')
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Design By <a href="#">Stenly Mandala</a>
        </div>
